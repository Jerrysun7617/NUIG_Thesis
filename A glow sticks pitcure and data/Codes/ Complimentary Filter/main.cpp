...
It takes as inputs, the angle calculated from the accelerometer, and the rate of rotation in degrees/second from the gyro.
...
timeConstant is a value which is used to determine how quickly the calculated angle is corrected
by the accelerometer value. Play around with this value to get the best response/accuracy required.
/********************************************************************
